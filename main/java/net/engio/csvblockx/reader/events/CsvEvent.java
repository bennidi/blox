...
/**
 * An instance of {@link CsvEvent} is created by the {@link net.engio.csvblockx.reader.BlockXreader} for each line of a given source that represents relevant data. The event is passed to the corresponding handler
