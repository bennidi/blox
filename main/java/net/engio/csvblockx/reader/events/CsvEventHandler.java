...
/**
 * Event handlers are called by the {@link net.engio.csvblockx.reader.BlockXreader} to handle corresponding parser events. They can be used to implement
 * arbitrary operations on the csv data.
 * 
 * Example: The {@link CsvInMemoryBlockBuilder} implements a set of handlers for creating and populating instances of {@link ICsvBlock},
