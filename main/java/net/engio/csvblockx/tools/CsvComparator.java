...
public class CsvComparator {
	...
	private BlockXreaderFactory blockXreader;
	...
	public CsvComparator(boolean blockOrderImportant,
		...
		this.blockXreader = new BlockXreaderFactory(encoding);
	}
    ...
    public List<Difference> compare(InputStream csv1, InputStream csv2, ICsvBlockDefinition ...definitions) throws Exception {
        ...
        List<ICsvBlock> result1 = CsvBlockBuilder.getBlocks(doc1);
        List<ICsvBlock> result2 = CsvBlockBuilder.getBlocks(doc2);

        return compare(result1, result2);

    }

	public List<Difference> compare(List<ICsvBlock> csv1, List<ICsvBlock> csv2) {
	...
	public List<Difference> compare(ICsvBlock block1, ICsvBlock block2) {
		List<Difference> differences = new LinkedList<Difference>();
