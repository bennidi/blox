 ...
 * 
 */
public class CsvBlockDefinition implements ICsvBlockDefinition {

	private int headerLength = 0;

	private boolean columnHeadersForBlockBody = false;

	private ICsvFormat csvFormat = CsvFormat.Default();
	...
	@Override
	public CsvBlockDefinition headerSize(int headerLength) {
	...
	public CsvBlockDefinition hasColumnNames(boolean value) {
	...
	public interface BlockLimitBuilderStage2{
		...
		public CsvBlockDefinition emptyLine();
		
		public CsvBlockDefinition line(final int lineNumber);
		
		public CsvBlockDefinition pattern(final String regex);
	}
	...
	public class BlockLimitBuilder implements BlockLimitBuilderStage1, BlockLimitBuilderStage2{
		...
		public CsvBlockDefinition line(final int lineNumber) {
			...
			return CsvBlockDefinition.this; // return the outer instance
		}
		
		public CsvBlockDefinition emptyLine(){
			return pattern(CsvFormat.EmptyLine);
		}
